...
export const AuthPage = () => {
  ...
  const roles = [
    { id: "super-admin", label: "Super Admin", icon: Shield, description: "Full system access" },
    { id: "bank-admin", label: "Bank Admin", icon: Building, description: "Customer & ATM management" },
    { id: "security-analyst", label: "Security Analyst", icon: AlertTriangle, description: "Threat analysis & response" },
    { id: "customer", label: "Bank Customer", icon: CheckCircle, description: "Personal app security" }
  ];
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <Badge variant="outline" className="px-3 py-1 bg-success/10 border-success/30">
            <div className="w-2 h-2 bg-success rounded-full mr-2 pulse-live"></div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="admin@bankguard.ai"
                  required
                />
              </div>
